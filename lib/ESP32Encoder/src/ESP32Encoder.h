...
public:
	...
	// MIDI Stuff
	void setMIDIParam(u_char _ccNumber, u_char _midiChannel);
	void setCCNumber(u_char _ccNumber);
	void setMIDIChannel(u_char _midiChannel);
	u_char getControlNumber();
	u_char getCurrentCCMessage();
	u_char getMidiChannel();
...
private:
	...
	// MIDI Stuff
	u_char ccNumber, ccMessage, midiChannel;
};
